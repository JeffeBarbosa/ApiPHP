...
class Register extends Conexao
{
    ...
    {
        $registers = $this->pdo->query('SELECT P.idprofissional,C.tipo_cadastro, C.nome, C.telefone , P.form_profissao as Profissao, P.idprofissao from cadastro C inner join cad_profissional P on C.idcadastro = P.cadastro_idcadastro where C.tipo_cadastro = 2 and p.idprofissional != 44;')->fetchAll(\PDO::FETCH_ASSOC);
        return $registers;
    }
